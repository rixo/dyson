...
describe('dyson', function() {
    ...
    describe('.registerServices', function() {
        ...
        it('should add GET route to Express', function() {
            ...
            spy.firstCall.args[3].should.equal(config.get[0].callback);
            spy.firstCall.args[4].should.equal(config.get[0].render);
        ...
        it('should add POST route to Express', function() {
            ...
            spy.firstCall.args[3].should.equal(config.post[0].callback);
            spy.firstCall.args[4].should.equal(config.post[0].render);
